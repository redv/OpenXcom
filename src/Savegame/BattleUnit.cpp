...
BattleUnit::BattleUnit(Soldier *soldier, int depth) :
	...
	_motionPoints(0), _scannedTurn(-1), _kills(0), _hitByFire(false), _moraleRestored(0), _coverReserve(0), _charging(0),
...
BattleUnit::BattleUnit(Unit *unit, UnitFaction faction, int id, Armor *armor, int diff, int depth) :
	...
	_expThrowing(0), _expPsiSkill(0), _expPsiStrength(0), _expMelee(0), _motionPoints(0), _scannedTurn(-1), _kills(0), _hitByFire(false),
